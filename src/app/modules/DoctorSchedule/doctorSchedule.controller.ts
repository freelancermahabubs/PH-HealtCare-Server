...
const insertIntoDB = catchAsync(async (req: Request & { user?: IAuthUser }, res) => {
...
const getMySchedule = catchAsync(async (req: Request & { user?: IAuthUser }, res) => {
...
const deleteFromDB = catchAsync(async (req: Request & { user?: IAuthUser }, res) => {
